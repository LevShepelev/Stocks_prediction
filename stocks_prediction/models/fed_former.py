...
from stocks_prediction.layers.auto_correlation import (
    AutoCorrelationLayer,
)
from stocks_prediction.layers.auto_former_enc_dec import (
    Decoder,
    DecoderLayer,
    Encoder,
    EncoderLayer,
...
from stocks_prediction.layers.embed import DataEmbedding_wo_pos
from stocks_prediction.layers.fourier_correlation import (
    FourierBlock,
    FourierCrossAttention,
)
from stocks_prediction.layers.multi_wavelet_correlation import (
    MultiWaveletCross,
...
class Model(nn.Module):
    """
    FEDformer performs the attention mechanism on
    frequency domain and achieved O(N) complexity
    """
    ...
    def __init__(self, configs):
        ...
        self.decoder = Decoder(
            [
                ...
                for layer in range(configs.d_layers)
            ],
            norm_layer=my_Layernorm(configs.d_model),
